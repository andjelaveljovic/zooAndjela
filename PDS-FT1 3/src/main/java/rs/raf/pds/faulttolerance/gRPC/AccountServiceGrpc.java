...
public final class AccountServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "AccountService";
  ...
  private static volatile io.grpc.MethodDescriptor<rs.raf.pds.faulttolerance.gRPC.LogRequest,
      rs.raf.pds.faulttolerance.gRPC.LogEntry> getMissingEntryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MissingEntry",
      requestType = rs.raf.pds.faulttolerance.gRPC.LogRequest.class,
      responseType = rs.raf.pds.faulttolerance.gRPC.LogEntry.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<rs.raf.pds.faulttolerance.gRPC.LogRequest,
      rs.raf.pds.faulttolerance.gRPC.LogEntry> getMissingEntryMethod() {
    io.grpc.MethodDescriptor<rs.raf.pds.faulttolerance.gRPC.LogRequest, rs.raf.pds.faulttolerance.gRPC.LogEntry> getMissingEntryMethod;
    if ((getMissingEntryMethod = AccountServiceGrpc.getMissingEntryMethod) == null) {
      synchronized (AccountServiceGrpc.class) {
        if ((getMissingEntryMethod = AccountServiceGrpc.getMissingEntryMethod) == null) {
          AccountServiceGrpc.getMissingEntryMethod = getMissingEntryMethod =
              io.grpc.MethodDescriptor.<rs.raf.pds.faulttolerance.gRPC.LogRequest, rs.raf.pds.faulttolerance.gRPC.LogEntry>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MissingEntry"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  rs.raf.pds.faulttolerance.gRPC.LogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  rs.raf.pds.faulttolerance.gRPC.LogEntry.getDefaultInstance()))
              .setSchemaDescriptor(new AccountServiceMethodDescriptorSupplier("MissingEntry"))
              .build();
        }
      }
    }
    return getMissingEntryMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void missingEntry(rs.raf.pds.faulttolerance.gRPC.LogRequest request,
        io.grpc.stub.StreamObserver<rs.raf.pds.faulttolerance.gRPC.LogEntry> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMissingEntryMethod(), responseObserver);
    }
  }
  ...
  public static final class AccountServiceStub
    ...
    /**
     */
    public void missingEntry(rs.raf.pds.faulttolerance.gRPC.LogRequest request,
        io.grpc.stub.StreamObserver<rs.raf.pds.faulttolerance.gRPC.LogEntry> responseObserver) {
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getMissingEntryMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  private static final int METHODID_MISSING_ENTRY = 5;
      ...
      switch (methodId) {
        ...
        case METHODID_GET_LEADER_INFO:
          serviceImpl.getLeaderInfo((rs.raf.pds.faulttolerance.gRPC.LeaderRequest) request,
              (io.grpc.stub.StreamObserver<rs.raf.pds.faulttolerance.gRPC.LeaderInfo>) responseObserver);
          break;
        case METHODID_MISSING_ENTRY:
          serviceImpl.missingEntry((rs.raf.pds.faulttolerance.gRPC.LogRequest) request,
              (io.grpc.stub.StreamObserver<rs.raf.pds.faulttolerance.gRPC.LogEntry>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          getMissingEntryMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              rs.raf.pds.faulttolerance.gRPC.LogRequest,
              rs.raf.pds.faulttolerance.gRPC.LogEntry>(
                service, METHODID_MISSING_ENTRY)))
        .build();
  }
      ...
      synchronized (AccountServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getMissingEntryMethod())
              .build();
        }
      }
    }
